...
class ImageCarousel extends Component {
    state = {
        items: [
            {id: 0, img: Image1, className: 'item item-left', icon: Icon1, text: '三农领域'},
            {id: 1, img: Image2, className: 'item item-center', icon: Icon2, text: '金融领域'},
            {id: 2, img: Image3, className: 'item item-right', icon: Icon3, text: '装备制造领域'},
        ]
    };
